...
var programas_new = {
    ...
    methods : {
        createPrograma(){
            axios.post(`http://api-academic-eb2.eba-djdygium.us-west-2.elasticbeanstalk.com/gestionacademica/listar_programas/`,{
...
var vm = new Vue({
    ...
    methods: {
        listarProgramas(){
            axios.get(`http://api-academic-eb2.eba-djdygium.us-west-2.elasticbeanstalk.com/gestionacademica/listar_programas/`)
            .then(
        ...
        editPrograma(){
           axios.put(`http://api-academic-eb2.eba-djdygium.us-west-2.elasticbeanstalk.com/gestionacademica/detalles_programa/${this.program.codigo_programa}`,{
        ...
        deletePrograma(datosPrograma){
           ...
           if(confirmacion){
                axios.delete(`http://api-academic-eb2.eba-djdygium.us-west-2.elasticbeanstalk.com/gestionacademica/detalles_programa/${datosPrograma.codigo_programa}`)
                .then(reponse => {
                    this.listarProgramas();
                })
                .catch(error => {
