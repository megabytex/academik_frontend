...
var vm = new Vue({
    ...
    methods: {
        ...
        editPrograma(){
           axios.put(`http://api-academic-eb.eba-vdc8i6ut.us-west-2.elasticbeanstalk.com/gestionacademica/detalles_programa/${this.program.codigo_programa}`,{
        ...
        deletePrograma(datosPrograma){
           ...
           if(confirmacion){
                axios.delete(`http://api-academic-eb.eba-vdc8i6ut.us-west-2.elasticbeanstalk.com/gestionacademica/detalles_programa/${datosPrograma.codigo_programa}`)
                .then(reponse => {
                    this.listarProgramas();
                })
                .catch(error => {
