...
var programas_new = {
    ...
    methods : {
        createPrograma(){
            axios.post(`http://127.0.0.1:8000/gestionacademica/listar_programas/`,{
...
var vm = new Vue({
    ...
    methods: {
        listarProgramas(){
            axios.get(`http://127.0.0.1:8000/gestionacademica/listar_programas/`)
            .then(
        ...
        editPrograma(){
           axios.put(`http://127.0.0.1:8000/gestionacademica/detalles_programa/${this.program.codigo_programa}`,{
        ...
        deletePrograma(datosPrograma){
           ...
           if(confirmacion){
                axios.delete(`http://127.0.0.1:8000/gestionacademica/detalles_programa/${datosPrograma.codigo_programa}`)
                .then(reponse => {
                    this.listarProgramas();
                })
                .catch(error => {
